...
* [x] **Task 1.1: Release Version & Metadata Synchronization**
...
* [x] **Task 1.2: Strict POSIX Permissions & User Validation**
...
* [x] **Task 1.3: Zero-Leak Credential Management**
...
* [x] **Task 1.4: Dynamic Multi-Distro Fingerprinting & Path Resolver**
...
* [x] **Task 1.5: RFC 2849 Stream-Safe LDIF Unfolding & Operational Attribute Stripping**
...
* [x] **Task 1.6: SQLite3 WAL Initialization & Legacy Fallback**
...
* [x] **Task 2.1: Zero-Timeout Socket Enforcement (`-t 0`)**
...
* [x] **Task 2.2: Per-Artifact SHA-256 Checksum Generation**
...
* [x] **Task 2.3: Universal Manifest V2.0 Generation (`MANIFEST.json`)**
...
* [x] **Task 2.4: Session Integrity Checker (`zmbackup -c / --check-integrity`)**
...
* [x] **Task 2.5: Dynamic JVM RAM Gate & Worker Throttling**
...
* [x] **Task 2.6: Checkpoint State Tracking & Resume Engine (`--resume`)**
...
* [x] **Task 3.1: Explicit Conflict Resolution Strategy (`--resolve`)**
...
* [x] **Task 3.2: Dynamic Hostname Remapping Engine (`--rewrite-host`)**
...
* [x] **Task 3.3: Automatic Missing Domain Pre-Creation**
...
* [x] **Task 3.4: Class of Service (COS) Normalization & Fallback**
...
* [x] **Task 3.5: Zip-Slip & Path Traversal Mitigations (CVE-2022-27925 class)**
...
* [x] **Task 3.6: Pre-Restore Dry-Run Mode (`--dry-run`)**
...
* [x] **Task 4.1: Signatures, Sieve Rules & Vacation Responder Extraction**
...
* [x] **Task 4.2: Shared Folder Grants Backup (`getFolderGrant`)**
...
* [x] **Task 4.3: Multi-Core Compression Dispatcher (`zstd` / `pigz` / `gzip`)**
...
* [x] **Task 4.4: Folder & Content Filtering (`EXCLUDE_FOLDERS`)**
...
* [x] **Task 5.1: Pre-Flight Health Diagnostic Suite (`zmbackup --health`)**
...
* [x] **Task 5.2: Structured Session Listing (`-l --json` / `-l --csv`)**
...
* [x] **Task 5.3: Enhanced Real-Time Progress Indicators**
...
* [x] **Task 6.1: ShellCheck Static Analysis**
...
* [x] **Task 6.2: BATS Unit & Integration Test Suite**
...
* [x] **Task 6.3: Simulated Multi-Worker Concurrency Stress Test**
